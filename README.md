...
* Este framework de código PHP libre y licencia GPL nace para **FACILITAR** el documentar **DE MANERA DISTRIBUIDA** los incidentes en base a Normas NIA / NIF / NIIF y realización de puntos COHA, en base a las normas de auditoría internacionales poermitiendo que varias personas hagan avances a la vez sin depender de archivos word, lo que resulta necesario cuando hablamos de casos extensos. El análisis COHA y el reporte master de auditoría que hicimos como base eran de 4 y 330 Páginas respectivamente sin considerar los papeles de trabajo 230 ni presentaciones ejecutivas o de entrenamiento académico.
